...
<body>
    ...
    <a href="<?php echo e(route('perawat.rekam_medis.create')); ?>" class="btn">Tambah Rekam Medis</a>
        ...
        <tbody>
            <?php $__currentLoopData = $dataRekam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($r->pet->nama ?? '-'); ?></td>
                    <td><?php echo e($r->diagnosa); ?></td>
                    <td><?php echo e($r->dokter_pemeriksa); ?></td>
...
<?php /**PATH C:\laragon\www\laravel\laravelrshp\resources\views/perawat/rekam_medis.blade.php ENDPATH**/ ?>