...
<body>
    <h2>Kategori</h2>
    <table>
        <button><a href="<?php echo e(route('admin.kategori.create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Kategori</a></button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form id="delete-form-<?php echo e($item->idkategori); ?>" action="#" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
    ...
    </table><?php /**PATH C:\laragon\www\laravel\laravelrshp\resources\views/admin/kategori/index.blade.php ENDPATH**/ ?>