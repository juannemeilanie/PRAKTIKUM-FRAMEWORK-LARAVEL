            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    <div class="card-footer clearfix">
                        <a href="<?php echo e(route('resepsionis.pemilik.index')); ?>" class="btn btn-primary btn-sm float-end">Lihat Semua</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mt-4">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    <div class="card-footer clearfix">
                        <a href="<?php echo e(route('resepsionis.pet.index')); ?>" class="btn btn-primary btn-sm float-end">Lihat Semua</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-sm mt-4 mb-5">
            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    ...
                    <div class="card-footer clearfix">
                        <a href="<?php echo e(route('resepsionis.temu-dokter.index')); ?>" class="btn btn-primary btn-sm float-end">Lihat Semua</a>
                    </div>
                </div>
            </div>
        </div>
