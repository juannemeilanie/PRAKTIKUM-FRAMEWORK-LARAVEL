...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(route('site.struktur')); ?>">Struktur Organisasi</a></li>
            <li><a href="<?php echo e(route('site.layanan')); ?>">Layanan Umum</a></li>
            <li><a href="<?php echo e(route('site.visimisi')); ?>">Visi Misi dan Tujuan</a></li>
...
</body><?php /**PATH C:\laragon\www\laravel\laravelrshp\resources\views/site/home.blade.php ENDPATH**/ ?>