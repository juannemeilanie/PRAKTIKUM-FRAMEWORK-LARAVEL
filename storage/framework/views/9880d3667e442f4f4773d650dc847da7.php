...
<body>
    ...
    <table>
        <button><a href ="<?php echo e(route('admin.user-role.create')); ?>"  method="POST" class="btn btn-danger w-100 fw-bold">Tambah Role User</a></button>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-sm btn-danger" onclick="if(confirm('Apakah Anda yakin ingin menghapus data ini?')) { document.getElementById('delete-form-<?php echo e($userRole->id); ?>').submit(); }">
                        <i class="fas fa-trash"></i> Hapus
                    </button>
                    <form id="delete-form-<?php echo e($userRole->id); ?>" action="#" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
