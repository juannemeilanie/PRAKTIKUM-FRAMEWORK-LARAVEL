            ...
            <form action="{{ route('admin.perawat.update', $perawat->idperawat) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select name="jenis_kelamin" class="form-control">
                        <option value="Laki-Laki" {{ $perawat->jenis_kelamin == 'Laki-Laki' ? 'selected' : '' }}>Laki-Laki</option>
                        <option value="Perempuan" {{ $perawat->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                    </select>
                </div>
