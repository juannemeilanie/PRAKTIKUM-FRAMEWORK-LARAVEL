        ...
        <div class="col-md-8">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.kode-tindakan.update', $kodetindakan->idkode_tindakan_terapi) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input  type="text" 
                                    ...
                                    value="{{ old('deskripsi_tindakan_terapi', $kodetindakan->deskripsi_tindakan_terapi) }}" 
